  ...
  <div class="flex fixed w-full items-center px-6 h-16 gap-x-4 bg-gray-100 dark:bg-gray-600 z-index-10">
    <NuxtLink to="/">
      ...
      <div class="flex justify-self-end">
        ...
        >
          <button class="text-black dark:text-white text-2xl p-2 font-bold" @click="tog()">&#9776;</button>
        </div>
      </div>
      <nav
      ...
      <ul class="list-none text-gray-800 dark:text-gray-100">
        ...
        <li class="pl-14">
          <div class="mt-6 -ml-7">
            ...
            <div role="group" aria-labelledby="teams-headline" class="mt-1 ml-3 space-y-1">
              <a
